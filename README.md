...
- جدول: أحدث 20 تنبيه حرج (فلترة `severity = Critical`) مع `analyst_assigned` و`status`
- شريحة تصفية (Slicer): فترة زمنية + `detection_source`

استخدمي **Bookmarks** لعمل زر تبديل بين الصفحتين بشكل احترافي.
